...
This package allows for easy post processing of latex `stargazer`
output. See
...
papers [here](https://chandlerlutz.github.io/pdf/california-foreclosure-prevention-laws.pdf) and [here](). All of these tables were generated
exclusively withing R using `stargazer` and `starpolishr`.
